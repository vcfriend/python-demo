...
=======================================================
莫纳罗亚火山CO2数据的高斯过程回归(GPR)
=======================================================
这个例子基于“机器的高斯过程”的5.4.3节
学习”(RW2006) _。给出了一个复杂内核工程的实例
基于梯度上升的超参数优化
log-marginal-likelihood。这些资料包括每月的大气平均值
二氧化碳浓度(以百万分之一体积计(ppm))收集
1958年到2001年间，夏威夷的莫纳罗亚天文台。目标是
将二氧化碳浓度建模为时间的函数:数学:‘t’并进行推断
2001年之后的很多年。
．． 主题:引用
. .[RW2006]“拉斯穆森，卡尔爱德华。
"机器学习中的高斯过程"
机器学习暑期班。施普林格，柏林，海德堡，2003年
