'''
在写作本代码时，用pandas注入数据，bar的介素时间是2013-03-28 00:00:00而不是正常的2013-03-28 23:59:59，所以结果不正确。
backtrader开发者在解决这个问题https://community.backtrader.com/topic/3130/timer-problem/7
...
class Strategy(bt.Strategy):
    ...
    def rebalance_portfolio(self):
        ...
        self.ranks = [d for d in self.stocks if
                      ...
                      # 今日未停牌，若去掉此句，则今日停牌的也可能进入，
                      # 并下订单，次日若复牌，则次日可能成交，假设原始数据中已删除无交易的记录
