...
class DataStrategy(bt.Strategy):
    ...
    def next(self):
        ...
        self.log('Open: {:.2f} High: {:.2f} Low: {:.2f} Close: {:.2f}'.format(self.data.open[0], self.data.high[0],
                                                                              self.data.low[0], self.data.close[0]))
        print('last bar of large TF')
        self.log('Open: {:.2f} High: {:.2f} Low: {:.2f} Close: {:.2f}'.format(self.data.open[-1], self.data.high[-1],
