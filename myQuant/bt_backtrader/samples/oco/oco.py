...
#
# 本程序是自由软件:您可以根据自由软件基金会发布的GNU通用公共许可证的条款重新发布和/或修改它，该许可证的第三版或(由您选择)任何后续版本。

# 这个程序的发布是希望它将是有用的，但没有任何保证;甚至没有隐含的适销性或适合特定目的的保证。有关更多细节，请参阅GNU通用公共许可证。

# 您应该已经收到与本程序一起的GNU通用公共许可证的副本。如果没有，请参见<http://www.gnu.org/licenses/>.
###############################################################################
